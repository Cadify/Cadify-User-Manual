...
**Example Screenshot**  
<img src="https://raw.githubusercontent.com/Cadify/Cadify-User-Manual/main/docs/cadify/sketcher/images/image.png" alt="Example" style="max-width:100%; height:auto; border:1px solid #ccc; border-radius:6px;">
...
- Check out each UDF documentation:
    - [CadifySheet](cadifysheet.md)
    - [CadifyLine](cadifyline.md)
    - [CadifyRectangle](cadifyrectangle.md)
    - [CadifyEllipse](cadifyellipse.md)
    - [CadifyHoles](cadifyholes.md)
    - [CadifyImage](cadifyimage.md)
    - [CadifyDim](cadifydim.md)
    - [CadifyText](cadifytext.md)
    - [CadifyGraph](cadifyGraph.md)
...
1. **Add a New Web Control**  
   ...
   <img src="https://raw.githubusercontent.com/Cadify/Cadify-User-Manual/main/docs/cadify/sketcher/images/addControl.png" alt="AddControl" style="max-width:100%; height:auto; border:1px solid #ccc; border-radius:6px;">

2. **Creation Example**  
   <img src="https://raw.githubusercontent.com/Cadify/Cadify-User-Manual/main/docs/cadify/sketcher/images/createSvg.png" alt="CreationExample" style="max-width:100%; height:auto; border:1px solid #ccc; border-radius:6px;">

3. **Product Preview in NopCommerce**  
   <img src="https://raw.githubusercontent.com/Cadify/Cadify-User-Manual/main/docs/cadify/sketcher/images/nopCpreview.png" alt="ProductPreview" style="max-width:100%; height:auto; border:1px solid #ccc; border-radius:6px;">
